...
FXlsApp := CreateOleObject('Excel.Application');
 ...
 procedure BoxGKXScriptTarifClik;  //ЖКХ
begin
  XlsStart;
  ...
  procedure BoxHkolaScriptTarifClik;//Дошкольные учреждения
begin
  XlsStart;
  FXlsApp.Visible := false;
  //FXlsApp.WorkBooks.Add('');
...
procedure BoxObheeObrozScriptTarifClik;// Общее образование   Больницы
begin
  XlsStart;
  FXlsApp.Visible := false;
  //FXlsApp.WorkBooks.Add('');
...
procedure BoxBolnicScriptTarifClik;//Больницы
begin
  XlsStart;
  FXlsApp.Visible := false;
  //FXlsApp.WorkBooks.Add('');
 ...
 procedure  BoxPoliclinScriptTarifClik;//  Полиники
 begin
  XlsStart;
  FXlsApp.Visible := false;
  //FXlsApp.WorkBooks.Add('');
...
procedure  BoxKyltScriptTarifClik; //Культура
 begin
  XlsStart;
  FXlsApp.Visible := false;
  //FXlsApp.WorkBooks.Add('');
...
procedure BoxFizKeltScriptTarifClik; //Физическая культура
 begin
  XlsStart;
  FXlsApp.Visible := false;
  //FXlsApp.WorkBooks.Add('');
