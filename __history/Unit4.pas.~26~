...
ComboBoxDimografia.Items.Add('Модель, общая численность населения (тыс чел)');
ComboBoxDimografia.Items.Add('Дошкольники, тыс. чел.');
ComboBoxDimografia.Items.Add('Реципиенты отрасли Образование(тыс чел)');
...
if not XlsConnect then
  ...
  FXlsApp.WorkBooks.open(ExtractFilePath(Application.ExeName)+'Модель\БД_Соц_сфера.xlsx');
...
StringGridDimografia.Cells[0,0]:='Год';
StringGridDimografia.Cells[0,1]:='Значение';
...
begin
if AnsiCompareText('Модель, общая численность населения (тыс чел)',Trim(ComboBoxDimografia.Text)) = 0 then
begin//11
for I := 1 to 26 do
for x := 0 to StringGridDimografia.RowCount-1 do
...
ChartDinamic.View3d:=False;//Чтоб была линия
 FXlsApp.ActiveWorkbook.Save;
 FXlsApp.ActiveWorkbook.Close;
end
else
begin
if AnsiCompareText('Дошкольники, тыс. чел.',Trim(ComboBoxDimografia.Text)) = 0 then
begin//12
for I := 1 to 26 do
for x := 0 to StringGridDimografia.RowCount-1 do
...
begin
if AnsiCompareText('Реципиенты отрасли Образование(тыс чел)',Trim(ComboBoxDimografia.Text)) = 0 then
begin//13
for I := 1 to 26 do
for x := 0 to StringGridDimografia.RowCount-1 do
...
//ringGrid1.Cells[0,x]:=IntToStr(x);
StringGridDinamic.Cells[0,0]:='Год';
StringGridDinamic.Cells[0,1]:='Значение';
...
begin//1 блок
if AnsiCompareText('Мощности непроизводственной сферы на начало года, нат.ед (кв м)',Trim(ComboBoxDinamic.Text)) = 0 then
begin//11
for I := 1 to 26 do
for x := 0 to StringGridDinamic.RowCount-1 do
...
begin
if AnsiCompareText('Эксплозатраты текущего года - план (тыс.руб)',Trim(ComboBoxDinamic.Text)) = 0 then
begin//12
for I := 1 to 26 do
for x := 0 to StringGridDinamic.RowCount-1 do
...
begin
if AnsiCompareText('Ввод новых мощностей текущего года ЗА СЧЕТ БЮДЖЕТА- факт, нат.ед.',Trim(ComboBoxDinamic.Text)) = 0 then
begin//13
for I := 1 to 26 do
for x := 0 to StringGridDinamic.RowCount-1 do
...
begin
if AnsiCompareText('Плата населения (тыс.руб) (ПЛАН)',Trim(ComboBoxDinamic.Text)) = 0 then
begin//14
for I := 1 to 26 do
for x := 0 to StringGridDinamic.RowCount-1 do
...
begin
if AnsiCompareText('Дошкольные учреждения',Trim(DBLookupComboBoxDinamic.Text)) = 0 then
begin//2 блок
if AnsiCompareText('Мощности непроизводственной сферы на начало года, нат.ед',Trim(ComboBoxDinamic.Text)) = 0 then
begin//21
for I := 1 to 26 do
for x := 0 to StringGridDinamic.RowCount-1 do
...
begin
if AnsiCompareText('ФЗП (тыс. руб.)-план',Trim(ComboBoxDinamic.Text)) = 0 then
begin//23
for I := 1 to 26 do
for x := 0 to StringGridDinamic.RowCount-1 do
...
begin
if AnsiCompareText('Ввод новых мощностей текущего года - факт, нат.ед.',Trim(ComboBoxDinamic.Text)) = 0 then
begin//24
for I := 1 to 26 do
for x := 0 to StringGridDinamic.RowCount-1 do
...
begin
if AnsiCompareText('Плата населения (тыс.руб) (факт)',Trim(ComboBoxDinamic.Text)) = 0 then
begin//26
for I := 1 to 26 do
for x := 0 to StringGridDinamic.RowCount-1 do
...
begin
if AnsiCompareText('Общее образование',Trim(DBLookupComboBoxDinamic.Text)) = 0 then
begin//3 блок
if AnsiCompareText('Мощности непроизводственной сферы на начало года, нат.ед',Trim(ComboBoxDinamic.Text)) = 0 then
begin//31
for I := 1 to 26 do
...
begin
if AnsiCompareText('Больницы',Trim(DBLookupComboBoxDinamic.Text)) = 0 then
begin//4 блок
if AnsiCompareText('Мощности непроизводственной сферы на начало года, нат.ед',Trim(ComboBoxDinamic.Text)) = 0 then
begin//41
for I := 1 to 26 do
...
begin
if AnsiCompareText('Поликлиники',Trim(DBLookupComboBoxDinamic.Text)) = 0 then
begin//5 блок
if AnsiCompareText('Мощности непроизводственной сферы на начало года, нат.ед',Trim(ComboBoxDinamic.Text)) = 0 then
begin//51
for I := 1 to 26 do
...
begin
if AnsiCompareText('Культура',Trim(DBLookupComboBoxDinamic.Text)) = 0 then
begin//6 блок
if AnsiCompareText('Мощности непроизводственной сферы на начало года, нат.ед',Trim(ComboBoxDinamic.Text)) = 0 then
begin//61
for I := 1 to 26 do
...
PageControlDinamic.Visible:=True;//Видимость контроллера динамики (откл)
//----------------------Найстройка Димографии
StringGridDimografia.Width:=PageControlDinamic.Width;//Размер Табл
end;
