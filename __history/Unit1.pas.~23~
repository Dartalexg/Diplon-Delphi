...
begin//1 блок
if AnsiCompareText('Мощности непроизводственной сферы на начало года, нат.ед (кв м)',Trim(ComboBox1.Text)) = 0 then
ShowMessage('11')
else
begin
if AnsiCompareText('Эксплозатраты текущего года - план (тыс.руб)',Trim(ComboBox1.Text)) = 0 then
ShowMessage('12')
else
begin
if AnsiCompareText('Ввод новых мощностей текущего года ЗА СЧЕТ БЮДЖЕТА- факт, нат.ед.',Trim(ComboBox1.Text)) = 0 then
ShowMessage('13')
else
begin
if AnsiCompareText('Плата населения (тыс.руб) (ПЛАН)',Trim(ComboBox1.Text)) = 0 then
ShowMessage('14')
else
ShowMessage('15')
end;end;end;end
...
begin
if AnsiCompareText('Дошкольные учреждения',Trim(DBLookupComboBox1.Text)) = 0 then
begin//2 блок
if AnsiCompareText('Мощности непроизводственной сферы на начало года, нат.ед',Trim(ComboBox1.Text)) = 0 then
ShowMessage('21')
else
begin
if AnsiCompareText('Эксплозатраты текущего года - план (тыс.руб)',Trim(ComboBox1.Text)) = 0 then
...
begin
if AnsiCompareText('ФЗП (тыс. руб.)-план',Trim(ComboBox1.Text)) = 0 then
ShowMessage('23')
else
begin
if AnsiCompareText('Ввод новых мощностей текущего года - факт, нат.ед.',Trim(ComboBox1.Text)) = 0 then
ShowMessage('24')
else
begin
if AnsiCompareText('Плата населения (тыс.руб) (ПЛАН)',Trim(ComboBox1.Text)) = 0 then
...
begin
if AnsiCompareText('Плата населения (тыс.руб) (факт)',Trim(ComboBox1.Text)) = 0 then
ShowMessage('26')
else
ShowMessage('27')
...
begin
if AnsiCompareText('Общее образование',Trim(DBLookupComboBox1.Text)) = 0 then
begin//3 блок
if AnsiCompareText('Мощности непроизводственной сферы на начало года, нат.ед',Trim(ComboBox1.Text)) = 0 then
ShowMessage('31')
else
...
begin
if AnsiCompareText('Больницы',Trim(DBLookupComboBox1.Text)) = 0 then
begin//4 блок
if AnsiCompareText('Мощности непроизводственной сферы на начало года, нат.ед',Trim(ComboBox1.Text)) = 0 then
ShowMessage('41')
else
...
begin
if AnsiCompareText('Поликлиники',Trim(DBLookupComboBox1.Text)) = 0 then
begin//5 блок
if AnsiCompareText('Мощности непроизводственной сферы на начало года, нат.ед',Trim(ComboBox1.Text)) = 0 then
ShowMessage('51')
else
...
begin
if AnsiCompareText('Культура',Trim(DBLookupComboBox1.Text)) = 0 then
begin//6 блок
if AnsiCompareText('Мощности непроизводственной сферы на начало года, нат.ед',Trim(ComboBox1.Text)) = 0 then
ShowMessage('61')
else
