...
//------------------------------------------------------------------------------ вкладка Динамика обеспеченности
procedure DinamicObecpecClik;
  var
  x,i,k:integer;
...
PultUpav.TabSheet7.TabVisible:=False;   //вкладка Динамика обеспеченности    Диаграмма
...
End;
 ...
 procedure OpenDinamicObecpecClik;//открытие вкладки
 var i:integer;
 begin
