...
//if not XlsConnect then Проверка
  XlsStart;
...
PultUpav.StringGridDimografia.Cells[0,0]:='Год';
PultUpav.StringGridDimografia.Cells[0,1]:='Значение';
...
PultUpav.ChartDinamic.View3d:=False;//Чтоб была линия
